# ============================================================
# ABA_T5_multitask.py | Prefix
# Multitask T5 (text-to-text): sentiment + topic + selected
# - Train ONE model on mixed tasks using task-prefix
...
summary_path = os.path.join(PRED_DIR, "SUMMARY_multitask_prefix.csv")
